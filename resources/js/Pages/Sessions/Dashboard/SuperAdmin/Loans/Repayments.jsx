...
export default function Repayments() {
    ...
    return (
        <>
            <Head title="Loans - Repayments" />
            <AdminPanelLayout title="Loans" active="repayments" items={items}>
                <div className="border-b border-slate-200 px-6 py-4">
                    <div className="text-sm font-semibold text-slate-900">Repayments</div>
