...
export default function SystemAudit() {
    ...
    return (
        <>
            <Head title="Super Admin - System Audit" />
            <AdminPanelLayout title="Super Admin" active="system-audit" items={items}>
                <div className="border-b border-slate-200 px-6 py-4">
                    <div className="text-sm font-semibold text-slate-900">System Audit</div>
