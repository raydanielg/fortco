...
export default function Dashboard({ auth }) {
    const isSuperAdmin = auth.user.roles?.some(r => r.name === 'super-admin') || auth.user.is_super_admin;
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mt-8 overflow-hidden bg-white shadow-sm sm:rounded-xl border border-gray-100">
                        <div className="p-6 text-gray-900">
                            <div className="text-lg font-bold">Welcome back, Super Admin!</div>
                            <div className="mt-2 text-sm text-gray-500">Everything is running smoothly. Your ERP system is up to date.</div>
                        </div>
                    </div>
                </div>
            </div>
