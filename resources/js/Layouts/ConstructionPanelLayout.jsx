...
export default function ConstructionPanelLayout({ title = 'Construction', active, items, children }) {
    return (
        <DashboardLayout title={title}>
            <div className="grid gap-6 lg:grid-cols-[280px,1fr]">
                        ...
                        {items.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isActive && <span className="h-6 w-1 rounded-full bg-slate-900" />}
                                </Link>
                            );
                        })}
                    </nav>
                ...
                <section className="rounded-2xl border border-slate-200 bg-white">{children}</section>
            </div>
        </DashboardLayout>
    );
}
